...
@section('js_files')
    ...
    {{-- Уведомления. --}}
    <script src="{{ URL::asset('ariol/assets/js/plugins/notifications/pnotify.min.js') }}"></script>
    <script src="{{ URL::asset('ariol/assets/js/plugins/notifications/jgrowl.min.js') }}"></script>
    {{-- Форма. --}}
